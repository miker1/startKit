                ...
                <?php echo Menu::widget([
                    ...
                    'items'=>[
                        ...
                        [
							...
							'options'=>['class'=>'treeview'],
							'items'=>[
								['label'=>Yii::t('backend', 'Attributes'), 'url'=>['/catalog/backend/attributes/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
								['label'=>Yii::t('backend', 'Categories'), 'url'=>['/catalog/backend/categories/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
								['label'=>Yii::t('backend', 'Products'), 'url'=>['/catalog/backend/products/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
								['label'=>Yii::t('backend', 'ProductTags'), 'url'=>['/catalog/backend/product-tags/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
								['label'=>Yii::t('backend', 'Tags'), 'url'=>['/catalog/backend/tags/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
								['label'=>Yii::t('backend', 'Values'), 'url'=>['/catalog/backend/values/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
								]
							],
