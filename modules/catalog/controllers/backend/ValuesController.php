...
use Yii;
use modules\catalog\models\common\Value;
use modules\catalog\models\backend\search\ValueSearch;
...
class ValuesController extends Controller
{
    ...
    public function actionCreate($product_id = null)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['/catalog/backend/products/view', 'id' => $model->product_id]);
        } else {
    ...
    public function actionDelete($product_id, $attribute_id)
    {
        ...
        return $this->redirect(['/catalog/backend/products/view', 'id' => $product_id]);
    }
